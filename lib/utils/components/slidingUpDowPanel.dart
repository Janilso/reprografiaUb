...
class SlidingUpDownPanel extends StatefulWidget {
  ...
  /// If non-null and true, the SlidingUpDownPanel exhibits a
  ...
  /// Allows toggling of the draggability of the SlidingUpDownPanel.
  ...
  @override
  _SlidingUpDownPanelState createState() => _SlidingUpDownPanelState();
}

class _SlidingUpDownPanelState extends State<SlidingUpDownPanel>
